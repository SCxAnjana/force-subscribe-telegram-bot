    ...
    if chat_member.restricted_by:
      if chat_member.restricted_by.id == (client.get_me()).id:
          try:
            ...
            client.answer_callback_query(cb.id, file = "downloads/photo_2021-07-27_15-02-08.jpg"
await client.send_file(event.chat_id, file, caption="ඔයා තාම අපේ Youtube Updates Channel එකට Join වෙලා නැහැනේ 😕 Please ඒකට Join වෙලා. පහල Unmute Button එක දෙන්න..🤗
එතකොට ඔයාට ලේසියෙන්ම අපේ Group එකෙන් Fims & Tv Series ලබාගන්න පුලුවන් වේවී😊👍 
𝘆𝗼𝘂 𝗮𝗿𝗲 𝗻𝗼𝘁 𝘀𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲𝗱 𝘁𝗼 𝗺𝘆 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘆𝗲𝘁. 𝗣𝗹𝗲𝗮𝘀𝗲 𝗷𝗼𝗶𝗻 𝗮𝗻𝗱 𝗽𝗿𝗲𝘀𝘀 𝘁𝗵𝗲 𝗯𝘂𝘁𝘁𝗼𝗻 𝗯𝗲𝗹𝗼𝘄 𝘁𝗼 𝘂𝗻𝗺𝘂𝘁𝗲 𝘆𝗼𝘂𝗿𝘀𝗲𝗹𝗳. 😊", show_alert=True)
      else:
      ...
      try:
        ...
        try:
          ...
          sent_message = message.reply_text(
              "{}, 𝘆𝗼𝘂 𝗮𝗿𝗲 𝗻𝗼𝘁 𝘀𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲𝗱 𝘁𝗼 𝗺𝘆 𝗰𝗵𝗮𝗻𝗻𝗲𝗹 𝘆𝗲𝘁. 𝗣𝗹𝗲𝗮𝘀𝗲 𝗷𝗼𝗶𝗻 𝗮𝗻𝗱 𝗽𝗿𝗲𝘀𝘀 𝘁𝗵𝗲 𝗯𝘂𝘁𝘁𝗼𝗻 𝗯𝗲𝗹𝗼𝘄 𝘁𝗼 𝘂𝗻𝗺𝘂𝘁𝗲 𝘆𝗼𝘂𝗿𝘀𝗲𝗹𝗳.ඔයා තාම අපේ චැනල් එකට Join වෙලා නෑ Join වූ පසු පහල බටනය ක්ලික් කර Unmute කරන්න.".format(message.from_user.mention),
